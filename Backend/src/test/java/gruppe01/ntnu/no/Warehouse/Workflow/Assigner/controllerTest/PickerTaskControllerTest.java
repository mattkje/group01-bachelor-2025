...
public class PickerTaskControllerTest {
    ...
    void testAssignWorkerToPickerTask() throws Exception {
        ...
        mockMvc.perform(put("/api/picker-tasks/assign-worker/{pickerTaskId}/{workerId}", pickerTaskId, workerId))
                .andExpect(status().isOk());
    ...
    void testRemoveWorkerFromPickerTask() throws Exception {
        ...
        mockMvc.perform(put("/api/picker-tasks/remove-worker/{pickerTaskId}/{workerId}", pickerTaskId, workerId))
                .andExpect(status().isOk());
