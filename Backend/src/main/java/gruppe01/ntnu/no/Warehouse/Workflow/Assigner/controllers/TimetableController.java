...
public class TimetableController {
     ...
     */
    public TimetableController(TimetableService timetableService, ZoneService zoneService, WorkerService workerService) {
    ...
    public ResponseEntity<Timetable> addTimetable(
        ...
        if (workerService.getWorkerById(workerId).isEmpty()) {
            ...
            return new ResponseEntity<>(timetableService.addTimetable(timetable, workerId), HttpStatus.CREATED);
        }
    }
