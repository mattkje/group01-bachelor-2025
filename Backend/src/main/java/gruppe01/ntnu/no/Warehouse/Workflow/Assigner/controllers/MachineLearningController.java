...
@Tag(name = "MachineLearningController", description = "Controller for managing machine learning operations")
public class MachineLearningController {
    ...
    @Operation(
            ...
            description = "Creates .ser files for machine learning models based on the specified department."
    )
    @ApiResponses(value = {
