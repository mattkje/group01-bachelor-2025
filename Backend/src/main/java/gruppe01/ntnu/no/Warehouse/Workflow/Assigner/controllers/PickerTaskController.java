...
public class PickerTaskController {
     ...
     */
    public PickerTaskController(PickerTaskService pickerTaskService, ZoneService zoneService, WorkerService workerService) {
    ...
    public ResponseEntity<PickerTask> updatePickerTask(
        ...
        if (pickerTask.getZone() == null || pickerTask.getDate() == null) {
            ...
            return ResponseEntity.ok(pickerTaskService.updatePickerTask(pickerTaskId, zoneId, pickerTask));
        }
    }
    ...
    public ResponseEntity<PickerTask> removeWorkerFromPickerTask(
        ...
        if (pickerTaskService.getPickerTaskById(pickerTaskId) == null ||
            ...
            return ResponseEntity.ok(pickerTaskService.removeWorkerFromPickerTask(pickerTaskId, workerId));
        }
    }
