...
public class WorkerController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved unavailable workers"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    public ResponseEntity<Worker> addLicenseToWorker(
        ...
        if (workerService.getWorkerById(id).isPresent() && licenseService.getLicenseById(licenseId) != null) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully added all licenses to workers"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
