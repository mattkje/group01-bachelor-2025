...
public class WorldSimDataService {
     ...
     */
    public WorldSimDataService(WorldSimDataRepository worldSimDataRepository, ZoneRepository zoneRepository, PickerTaskService pickerTaskService, ActiveTaskService activeTaskService) {
